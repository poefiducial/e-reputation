 ...
 * Connectionecommerce
 *
 * @ORM\Table(name="connectionecommerce", indexes={@ORM\Index(name="fk_connectionecommerce_e-commerces1", columns={"e-commerces_ide-commerce"}), @ORM\Index(name="fk_connectionecommerce_user1", columns={"user_iduser"})})
